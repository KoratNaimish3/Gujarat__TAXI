...
export default function Navigation() {
  ...
  return (
    ...
    <div className="flex items-center space-x-2 justify-center py-3 bg-gradient-to-br  from-orange-50  to-orange-50">
            <div>
              <Image src={assest.logo} alt="" className="w-28 h-24 object-cover"/>
            </div>
            <div className="">
              <h1 className="leading-7 text-4xl font-semibold text-[#98561f]" style={{fontFamily:"serif"}}>Gujarat Taxi</h1>
