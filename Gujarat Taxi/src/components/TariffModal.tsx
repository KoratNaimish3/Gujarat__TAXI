            ...
            <div className="space-y-6">
                  ...
                  <tbody>
                    {oneWayTariff.map((item, index) => (
                      ...
                      >
                        ...
                        <td className="px-6 py-4 text-orange-600 font-semibold text-lg">
                          {item.price}
                        </td>
                      </tr>
                    ))}
              ...
              <div className="bg-orange-50 border-l-4 border-orange-500 p-4 rounded-r-lg">
                <p className="text-sm text-gray-700 leading-relaxed">
                  <span className="font-semibold text-orange-600">*</span> Tariff does not include toll, parking, and other extra charges. Customers must pay these separately.
                </p>
              </div>
            </div>
          ) : (
