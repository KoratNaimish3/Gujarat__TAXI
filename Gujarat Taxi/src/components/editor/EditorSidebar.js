                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <select
                                ...
                                className="w-full border rounded-md p-2 text-sm bg-white text-black border-gray-300 focus:outline-none focus:ring-2 focus:ring-orange-400"
                            >
                                ...
                                <div className="mt-2">
                                    ...
                                    <div className="mt-2">
                                        ...
                                        <input
                                            ...
                                            className="w-full border rounded-md p-2 text-xs bg-white text-black border-gray-300 focus:outline-none focus:ring-2 focus:ring-orange-400"
                                        />
                                    </div>
                                </div>
                            )}
                        ...
                        <button
                            onClick={onSubmit}
                            disabled={loading}
                            className="w-full bg-orange-600 hover:bg-orange-700 text-white px-4 py-2 rounded-lg font-semibold text-sm disabled:opacity-50 disabled:cursor-not-allowed"
                        >
