...
export default function HeroSection() {
  ...
  return (
    <section
      id="home"
      className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-orange-50 via-white to-orange-100"
    >
      {/* Background Pattern */}
      <div className="absolute inset-0 opacity-5">
        ...
        <div className="absolute bottom-40 left-20 floating-icon">
          <Users className="w-14 h-14 text-orange-400" />
        </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          >
            Book Your Ride with{" "}
            <span className="text-gradient">Gujarat Taxi</span>
            <br />
