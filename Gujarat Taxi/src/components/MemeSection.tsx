          ...
          <div className="relative z-10 overflow-hidden rounded-xl  ">
            <div className="relative h-[280px] sm:h-[300px] md:h-[400px] lg:h-[500px] overflow-hidden rounded-xl">
              ...
              <button
                ...
                className="absolute left-1 sm:left-4 top-1/2 -translate-y-1/2 z-30 bg-white/90 hover:bg-white text-orange-600 hover:text-orange-700 rounded-full p-2 sm:p-3 shadow-lg transition-all duration-300 hover:scale-110"
              ...
              <button
                onClick={goToNext}
                className="absolute right-1 sm:right-4 top-1/2 -translate-y-1/2 z-30 bg-white/90 hover:bg-white text-orange-600 hover:text-orange-700 rounded-full p-2 sm:p-3 shadow-lg transition-all duration-300 hover:scale-110"
                ...
                {memeImages.map((image, index) => (
                  ...
                  >
                    <div className="relative w-full h-full flex items-center justify-center p-4">
                      <div className="rounded-xl border-2 border-orange-500 shadow-xl overflow-hidden inline-block max-w-full max-h-full">
