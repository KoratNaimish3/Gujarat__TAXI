          ...
          <div className="space-y-8 text-gray-700">
            <section>
              ...
              <p className="leading-relaxed">
                By accessing and using Gujarat Taxi's services, you accept and agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use our services.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="leading-relaxed">
                Gujarat Taxi provides taxi booking and transportation services across Gujarat, India. Our services include one-way trips, round trips, airport transfers, and outstation travel. We connect customers with professional drivers and vehicles.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside ml-4 space-y-2">
                <li>Gujarat Taxi shall not be liable for any indirect, incidental, or consequential damages</li>
            ...
            <section>
              ...
              <p className="leading-relaxed">
                All content, logos, trademarks, and intellectual property on our website and services are owned by Gujarat Taxi or our licensors. You may not use, reproduce, or distribute any content without our prior written permission.
              </p>
            </section>
