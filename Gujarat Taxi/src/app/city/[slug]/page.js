...
export default function CityPage() {
  ...
  useEffect(() => {
    const fetchCity = async () => {
      ...
      try {
        setLoading(true);
        const res = await fetch(`/api/cities/slug/${slug}`);
  ...
  useEffect(() => {
    if (!contentRef.current || !city?.blog) return;
      ...
      <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-orange-50">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center">
            ...
            <p className="text-gray-600 font-medium text-lg">Loading city...</p>
          </div>
        </div>
        <Footer_Components />
      </div>
      ...
      <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-orange-50">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center">
            ...
            <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">City Not Found</h1>
            <p className="text-gray-600 mb-6 text-lg">{error || "The city you're looking for doesn't exist."}</p>
            <Link
              href="/cities"
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12 overflow-x-hidden">
        ...
        <div className="bg-gradient-to-r from-white to-orange-50 rounded-2xl shadow-xl p-6 md:p-8 mb-8 border-2 border-orange-100 relative overflow-hidden">
          ...
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-orange-600 to-orange-500 bg-clip-text text-transparent">{city.name}</h1>
          </div>
        </div>
        ...
        {blog ? (
          ...
          <div className="bg-gradient-to-r from-white to-orange-50 rounded-2xl shadow-xl p-8 text-center border-2 border-orange-100">
            ...
            <p className="text-gray-600 font-medium text-lg">No blog content available for this city.</p>
          </div>
        )}
      </div>
