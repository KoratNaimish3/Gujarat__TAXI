          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            {sortedCities.map((city, index) => (
              <Link
                ...
                className="group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 p-6 md:p-8 border-2 border-transparent hover:border-orange-200 relative overflow-hidden"
              >
                ...
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-2xl md:text-3xl font-bold text-gray-900 group-hover:text-orange-700 transition-colors capitalize flex-1">
                    {city.name}
                  </h2>
                  <span className="text-orange-600 opacity-0 group-hover:opacity-100 transition-opacity text-2xl font-bold">→</span>
                </div>
              </Link>
            ))}
          </div>
