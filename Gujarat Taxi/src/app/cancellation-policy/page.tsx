          ...
          <div className="space-y-8 text-gray-700">
            <section>
              ...
              <p className="leading-relaxed">
                At Gujarat Taxi, we understand that plans can change. This Cancellation Policy outlines the terms and conditions for canceling your taxi booking and the applicable charges, if any.
              </p>
            </section>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside ml-4 space-y-2 mt-2">
                    <li>Calling our customer service at +91 95128 70958</li>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">
                3. Cancellation by Gujarat Taxi
              </h2>
              <div className="space-y-4">
                <div>
                  <h3 className="text-xl font-medium text-gray-900 mb-2">
