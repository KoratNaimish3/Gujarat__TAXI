    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-orange-50 overflow-x-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12 overflow-x-hidden">
                ...
                {/* Blog Content */}
                <article className="bg-white rounded-2xl shadow-xl border border-orange-600 overflow-hidden">
                    ...
                    <div className="md:flex md:items-stretch relative">
                        ...
                        {/* EXPERIENCE PANEL */}
                        <div className="md:w-1/2 w-full p-8 md:p-10 flex flex-col justify-center bg-gradient-to-br from-orange-50 via-white to-orange-100">
                            ...
                            {/* CTA */}
                            <button className="w-fit px-6 py-3 rounded-xl bg-gradient-to-r from-orange-500 to-orange-600 text-white font-semibold hover:scale-105 transition">
                                Book Taxi Now
                            </button>
                        </div>
                    </div>
